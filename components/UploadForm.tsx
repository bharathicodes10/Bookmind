...
const uploadFormSchema = z.object({
  pdfFile: z
    .instanceof(File)
    .refine((file) => file.size <= 50 * 1024 * 1024, 'PDF file must be 50MB or less'),
...
const MALE_VOICES = [
  ...
  { id: 'daniel', name: 'Daniel', description: 'Middle-aged male, British' },
    ...
    <div className="new-book-wrapper">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          {/* Male Voices */}
          <div>
            <p className="text-sm font-medium text-[#3d485e] mb-3">Male Voices</p>
          ...
          {/* Female Voices */}
          <div>
            <p className="text-sm font-medium text-[#3d485e] mb-3">Female Voices</p>
            <div className="voice-selector-options">
